...
export const decisionNodes: DecisionNode[] = [
  // ── FÁZE 0: Škoda Auto (regionální partner) ──
  {
    id: "skoda-free",
    tier: 0,
    order: 1,
    ...
    description:
      "Nejlogičtější první dveře. Škoda Auto má závod v Kvasinách 15 km od Rychnova — podpora místního mládežnického sportu je přirozený příběh společenské odpovědnosti.",
    ...
    nextMoveOnNe: "Zkusit zaměstnanecký program, zvýhodněný leasing nebo Nadační fond.",
    nextMoveOnPodminka: "Zjistit konkrétní podmínky a připravit požadované dokumenty.",
    relatedLeadIds: ["skoda-auto"],
    relatedTemplateIds: ["automotive-skoda"],
    sources: [sources[13], sources[6]],
  },
  {
    id: "skoda-employee",
    tier: 0,
    order: 2,
    label: "Zaměstnanecký/partnerský program Škoda",
    headline: "Sleva 20–40 % přes partnerský nebo zaměstnanecký program",
    description:
      "Škoda Auto nabízí zvýhodněné podmínky pro organizace v regionu závodů. Přes zaměstnanecký nebo partnerský program lze získat výraznou slevu na nový vůz.",
    estimatedValue: "Sleva 20–40 %",
    estimatedTimeframe: "2–4 týdny",
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["skoda-free", "skoda-lease"],
    steps: [
      "Zjistit podmínky partnerského programu Škoda Auto pro neziskové organizace.",
      "Doložit IČO, stanovy a účel pořízení vozu.",
      "Vyjednat individuální podmínky s regionálním zastoupením.",
    ],
    risks: [
      "Zaměstnanecký program může být omezený jen na zaměstnance a rodiny.",
      "Partnerský program nemusí být dostupný pro spolky.",
    ],
    nextMoveOnAno: "Vybrat model a objednat se slevou.",
    nextMoveOnNe: "Zkusit zvýhodněný leasing nebo Nadační fond.",
    nextMoveOnPodminka: "Ověřit, zda člen oddílu zaměstnaný ve Škodě může zprostředkovat.",
    relatedLeadIds: ["skoda-auto"],
    relatedTemplateIds: ["automotive-skoda"],
    sources: [sources[13]],
  },
  {
    ...
    tier: 0,
    order: 3,
    label: "Zvýhodněný leasing od Škoda",
    headline: "Operativní leasing přes Škoda s regionální slevou",
    description:
      "Škoda Financial Services nabízí operativní leasing s možností zvýhodněných podmínek pro regionální partnery. Servis a pojištění mohou být zahrnuty.",
    estimatedValue: "Úspora 3–6 000 Kč/měs.",
    estimatedTimeframe: "2–4 týdny",
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["skoda-free", "skoda-employee"],
    steps: [
      "Kontaktovat Škoda Financial Services s žádostí o nabídku pro spolek.",
      "Vyžádat operativní leasing na 9místný vůz (48–60 měsíců).",
      "Porovnat s nabídkami konkurenčních značek.",
    ],
    risks: [
      "Škoda nemusí mít vhodný 9místný model v nabídce.",
      "Podmínky leasingu pro spolky mohou být přísnější.",
    ],
    nextMoveOnAno: "Podepsat leasing a zajistit měsíční příjmy na splátky.",
    nextMoveOnNe: "Zkusit Nadační fond nebo přejít na konkurenční automobilky.",
    nextMoveOnPodminka: "Dodat požadované dokumenty a čekat na schválení.",
    relatedLeadIds: ["skoda-auto"],
    relatedTemplateIds: ["automotive-skoda"],
    sources: [sources[13]],
  },
  {
    ...
    nextMoveOnNe: "Přejít na konkurenční automobilky nebo dotace.",
    nextMoveOnPodminka: "Upravit žádost podle požadavků nadace a resubmit.",
    relatedLeadIds: ["nfsa"],
    sources: [sources[6]],
  },

  // ── FÁZE 1: Konkurenční automobilky ──
  {
    id: "competitor-free",
    tier: 1,
    order: 1,
    label: "Auto od konkurenční automobilky zdarma",
    headline: "Hyundai, Toyota nebo Ford jako alternativní partner",
    description:
      "Konkurenční značky mohou vidět příležitost v podpoře regionálního sportu v oblasti, kde dominuje Škoda — zvlášť pokud se o tom dozví.",
    estimatedValue: "Auto zdarma",
    ...
    complementaryIds: ["partner-club"],
    steps: [
      "Oslovit oddělení společenské odpovědnosti Hyundai, Toyota a Ford.",
    ...
    nextMoveOnNe: "Zkusit partnerský program nebo flotilový leasing.",
    nextMoveOnPodminka: "Dodat požadované materiály a čekat na rozhodnutí.",
    relatedLeadIds: ["hyundai", "toyota", "ford"],
    relatedTemplateIds: ["automotive-competition"],
    sources: [sources[8], sources[9], sources[11]],
  },
  {
    id: "competitor-program",
    tier: 1,
    order: 2,
    label: "Partnerský program konkurence",
    headline: "Zvýhodněné podmínky od Hyundai, Toyota, Ford nebo VW",
    description:
      "Automobilky nabízejí zvýhodněné podmínky pro neziskový sektor a sportovní organizace. Sleva 10–30 % z ceníkové ceny.",
    estimatedValue: "Sleva 10–30 %",
    estimatedTimeframe: "2–4 týdny",
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["competitor-free", "competitor-fleet"],
    steps: [
    ...
    relatedTemplateIds: ["automotive-competition"],
    sources: [sources[8], sources[10], sources[11], sources[12]],
  },
  {
    id: "competitor-fleet",
    tier: 1,
    ...
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["competitor-program", "partner-club"],
    steps: [
    ...
    risks: [
      ...
      "Nízký nájezd v nabídce nemusí stačit na soutěže po celé ČR.",
    ],
    nextMoveOnAno: "Podepsat leasing a zajistit měsíční příjmy na splátky.",
    ...
    relatedLeadIds: ["hyundai", "toyota", "ford", "autoin"],
    relatedTemplateIds: ["automotive-competition"],
    sources: [sources[8], sources[10], sources[11]],
  },
  {
    id: "competitor-demo",
    tier: 1,
    order: 4,
    label: "Předváděcí/skladový vůz se slevou",
    headline: "Téměř nové auto se slevou 15–30 % z ceníku",
    description:
      "Dealerství pravidelně prodávají předváděcí a skladové vozy se slevou. Vůz s 5–15 tis. km za výrazně nižší cenu, s plnou zárukou.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Přejít na varianty financování.",
    nextMoveOnPodminka: "Upravit žádost podle požadavků konkrétní nadace.",
  },

  // ── FÁZE 3: Varianty financování ──
  {
    id: "lease-operative",
    tier: 3,
    order: 1,
    label: "Operativní leasing",
    headline: "Vše v ceně (servis, pojištění), vůz se na konci vrací",
    description:
      "Operativní leasing zahrnuje servis, pojištění a pneumatiky v měsíční splátce. Na konci smlouvy se auto vrací leasingové společnosti — žádná starost o zůstatkovou hodnotu.",
    estimatedValue: "~19 000 Kč/měs.",
    estimatedTimeframe: "2–4 týdny",
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["partner-club", "lease-financial"],
    steps: [
      "Vyžádat nabídky od Toyota (KINTO ONE), Ford a VW.",
      "Porovnat měsíční splátky včetně servisu a pojištění.",
      "Ověřit podmínky předčasného ukončení a limitní kilometry.",
    ],
    risks: [
      "Nadlimitní kilometry mají vysoké penále (2–4 Kč/km).",
      "Auto nikdy nebude ve vlastnictví oddílu.",
      "Při předčasném ukončení hrozí vysoké penále.",
    ],
    nextMoveOnAno: "Podepsat leasing a zajistit měsíční příjmy na splátky.",
    nextMoveOnNe: "Zvážit finanční leasing nebo úvěr.",
    nextMoveOnPodminka: "Vyjednat vyšší roční nájezd nebo delší dobu.",
    relatedLeadIds: ["toyota", "ford", "autoin"],
    sources: [sources[10], sources[11]],
  },
  {
    id: "lease-financial",
    tier: 3,
    ...
    headline: "Na konci smlouvy vůz přechází do vlastnictví oddílu",
    description:
      "Finanční leasing má nižší měsíční splátku než operativní, ale servis a pojištění platíte zvlášť. Po splacení poslední splátky se auto stává majetkem oddílu.",
    estimatedValue: "~17 500 Kč/měs. + provoz",
    estimatedTimeframe: "2–4 týdny",
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["lease-operative", "loan-standard"],
    steps: [
      "Vyžádat nabídky finančního leasingu od min. 3 společností.",
      "Porovnat celkovou cenu (splátky × doba + akontace).",
      "Ověřit podmínky převodu vlastnictví na konci smlouvy.",
    ],
    risks: [
      "Servis a pojištění jsou nad rámec splátky — vyšší celkové náklady.",
      "Při nesplácení přijdete o auto i zaplacené splátky.",
    ],
    nextMoveOnAno: "Podepsat smlouvu a nastavit měsíční platby.",
    nextMoveOnNe: "Zvážit balónový úvěr s nižšími splátkami.",
    nextMoveOnPodminka: "Dodat požadované dokumenty a schválit bonitu.",
    relatedLeadIds: ["autoin"],
    sources: [sources[11]],
  },
  {
    ...
    order: 3,
    label: "Balónový úvěr",
    headline: "Nízké měsíční splátky + velká poslední splátka",
    description:
      "Balónový úvěr má nízké měsíční splátky (50–70 % standardního úvěru), ale na konci splatnosti je třeba zaplatit velkou poslední splátku (30–50 % ceny vozu).",
    estimatedValue: "~10 000 Kč/měs. + balón",
    estimatedTimeframe: "2–4 týdny",
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["loan-balloon-buyback", "loan-standard"],
    steps: [
      "Vyžádat nabídky s balónovou splátkou od bank a leasingových společností.",
      "Vyčíslit celkovou cenu včetně balónu na konci.",
      "Naplánovat, jak pokrýt poslední splátku (sbírka, grant, refinancování).",
    ],
    risks: [
      "Velká poslední splátka (300–500 000 Kč) může být problém.",
      "Celkově zaplatíte víc než u standardního úvěru.",
    ],
    nextMoveOnAno: "Podepsat smlouvu a začít plánovat pokrytí balónu.",
    nextMoveOnNe: "Zvážit balón s možností vrácení nebo klasický úvěr.",
    nextMoveOnPodminka: "Vyjednat nižší balónovou splátku nebo delší dobu.",
  },
  {
    id: "loan-balloon-buyback",
    tier: 3,
    order: 4,
    label: "Balón s možností vrácení",
    headline: "Nízké splátky a na konci možnost vrátit auto místo placení",
    description:
      "Varianta balónového úvěru, kde na konci nemusíte platit velkou splátku — místo toho vrátíte auto dealerovi. Kombinuje výhody operativního leasingu a úvěru.",
    estimatedValue: "~11 000 Kč/měs.",
    estimatedTimeframe: "2–4 týdny",
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["loan-balloon", "lease-operative"],
    steps: [
      "Vyžádat nabídky s garantovaným odkupem od dealerů.",
      "Ověřit podmínky vrácení (stav vozu, kilometry, poškození).",
      "Porovnat s operativním leasingem — co je výhodnější.",
    ],
    risks: [
      "Podmínky vrácení mohou být přísné (limit km, stav).",
      "Garantovaná zůstatková cena může být nízká.",
    ],
    nextMoveOnAno: "Podepsat smlouvu s opcí na vrácení.",
    nextMoveOnNe: "Zvážit klasický úvěr s rovnoměrnými splátkami.",
    nextMoveOnPodminka: "Vyjednat vyšší garantovanou zůstatkovou cenu.",
  },
  {
    id: "loan-standard",
    tier: 3,
    order: 5,
    label: "Klasický úvěr",
    headline: "Rovnoměrné splátky, auto je od začátku vaše",
    description:
      "Standardní úvěr s rovnoměrnými měsíčními splátkami. Auto je od podpisu smlouvy ve vlastnictví oddílu (resp. zástavě banky). Po splacení je plně vaše.",
    estimatedValue: "~17 500 Kč/měs.",
    estimatedTimeframe: "2–4 týdny",
    difficulty: "low",
    probability: "high",
    complementaryIds: ["lease-financial"],
    steps: [
      "Získat nabídky od 3 bank/leasingových společností.",
      "Porovnat RPSN, měsíční splátku a celkovou cenu.",
      "Zvážit vyšší akontaci pro nižší splátky.",
    ],
    risks: [
      "Vyšší měsíční splátky než u balónového úvěru.",
      "Při nesplácení banka může auto prodat.",
    ],
    nextMoveOnAno: "Podepsat úvěrovou smlouvu a koupit auto.",
    nextMoveOnNe: "Zvážit ojetý vůz za nižší cenu.",
    nextMoveOnPodminka: "Vyjednat delší splatnost nebo odklad splátek.",
  },
  {
    id: "demo-car",
    tier: 3,
    order: 6,
    label: "Předváděcí/skladový vůz",
    headline: "Téměř nové auto se slevou 15–30 % z ceníku",
    description:
      "Dealerství pravidelně prodávají předváděcí a skladové vozy se slevou. Vůz s 5–15 tis. km za výrazně nižší cenu než nový, s plnou zárukou. Platí pro jakoukoli značku.",
    estimatedValue: "Sleva 15–30 %",
    estimatedTimeframe: "1–4 týdny",
    difficulty: "low",
    probability: "high",
    ...
    nextMoveOnAno: "Zajistit financování (leasing/úvěr/hotovost) a koupit.",
    nextMoveOnNe: "Přejít na kombinaci zdrojů.",
    nextMoveOnPodminka: "Nechat si vůz rezervovat a mezitím zajistit finance.",
    relatedLeadIds: ["autoin"],
    sources: [sources[11], sources[12]],
  },

  // ── FÁZE 4: Kombinace zdrojů ──
  {
    id: "subsidized-lease",
    tier: 4,
    order: 1,
    label: "Splátky z kombinace zdrojů",
    headline: "Splátky pokryté z více příjmových proudů",
    description:
      "Splátky leasingu nebo úvěru (cca 17–19 000 Kč/měs.) pokrývají partneři + dotace + členské příspěvky. Klíč je mít potvrzené příjmy předem.",
    ...
    nextMoveOnAno: "Vybrat konkrétní auto a podepsat leasing/úvěr.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Přejít na vlastní příjmy.",
  ...
  // ── FÁZE 5: Vlastní příjmy ──
  {
    ...
    difficulty: "medium",
    probability: "high",
    complementaryIds: ["skoda-free", "lease-operative", "subsidized-lease"],
    steps: [
    ...
    nextMoveOnNe: "Zkusit dary od rodičů nebo veřejnou sbírku.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Zkusit veřejnou sbírku.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Nabídnout odměny: jméno na autě, pozvánka na soutěž.",
    ],
    risks: [
    ...
    nextMoveOnNe: "Přejít na poslední záchranu.",
  ...
  },
  {
    ...
    steps: [
      "Získat nabídky od 3 bank/leasingových společností.",
      "Porovnat RPSN, měsíční splátku a celkovou cenu.",
      "Zvážit ojetý vůz za 400–600k Kč místo nového za 950k+.",
    ],
    risks: [
...
export const vehicleOptions: VehicleOption[] = [
  {
    id: "new-9seat",
    label: "Nové 9místné auto",
    brand: "Různé značky",
    capacity: "9 míst",
    cashPrice: 950000,
    cashPriceWithDph: 1149500,
    leaseMonthly: 19000,
    leaseTerm: 60,
    leaseDeposit: 0,
    loanMonthly: 17500,
    ...
    source: {
      label: "Průměr nabídek Toyota, Ford, VW",
      url: "https://www.toyota.cz/kinto-one",
      note: "Orientační průměr cen nových 9místných vozů (Toyota Proace Verso, Ford Tourneo Custom, VW Caravelle).",
    },
  },
  {
    id: "used-van",
...
export const fundingSources: FundingSource[] = [
  ...
  {
    id: "fs-skoda-employee",
    label: "Program Škoda (sleva)",
    type: "corporate",
    estimatedMin: 50000,
    estimatedMax: 400000,
    probability: "medium",
    linkedNodeId: "skoda-employee",
    note: "Sleva 20–40 % přes zaměstnanecký/partnerský program.",
  },
  {
  ...
  {
    id: "fs-competitor-program",
    label: "Partnerský program (konkurence)",
    type: "corporate",
    estimatedMin: 50000,
    estimatedMax: 300000,
    probability: "medium",
    linkedNodeId: "competitor-program",
    note: "Sleva 10–30 % přes partnerský program automobilky.",
  },
  {
    id: "fs-competitor-fleet",
    label: "Flotilový leasing (konkurence)",
    type: "corporate",
    estimatedMin: 36000,
    estimatedMax: 96000,
    probability: "medium",
    linkedNodeId: "competitor-fleet",
...
export const PHASE_CONFIG: PhaseConfig[] = [
  {
    ...
    color: "var(--green)",
    nodeIds: ["skoda-free", "skoda-employee", "skoda-lease", "skoda-foundation"],
    description: "Nejlogičtější první dveře — Škoda Auto má závod v Kvasinách 15 km od Rychnova.",
  },
  {
    id: "faze-1",
    label: "FÁZE 1",
    name: "Konkurenční automobilky",
    color: "var(--green)",
    nodeIds: ["competitor-free", "competitor-program", "competitor-fleet", "competitor-demo"],
    description: "Hyundai, Toyota, Ford, VW — alternativy, pokud Škoda neodpoví.",
  },
  {
    id: "faze-2",
    label: "FÁZE 2",
  ...
  },
  {
    id: "faze-3",
    label: "FÁZE 3",
    name: "Varianty financování",
    color: "var(--accent)",
    nodeIds: ["lease-operative", "lease-financial", "loan-balloon", "loan-balloon-buyback", "loan-standard", "demo-car"],
    description: "Všechny způsoby, jak auto zaplatit — od operativního leasingu po klasický úvěr.",
  },
  {
    id: "faze-4",
    label: "FÁZE 4",
    name: "Kombinace zdrojů",
    color: "var(--gold)",
