...
export const decisionNodes: DecisionNode[] = [
  // ── FÁZE 1: Auto zdarma ──
  {
    ...
    nextMoveOnNe: "Přejít na fázi 2: zvýhodněné pořízení od automobilky.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Pokračovat fází 2 — zvýhodněné pořízení.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Přejít na fázi 2 — zvýhodněné pořízení.",
    nextMoveOnPodminka: "Upravit žádost podle požadavků nadace a resubmit.",
    relatedLeadIds: ["nfsa"],
  },

  // ── FÁZE 2: Zvýhodněné pořízení ──
  {
  ...
  },
  {
    ...
    nextMoveOnNe: "Zkusit předváděcí/skladový vůz nebo dotace.",
    nextMoveOnPodminka: "Dodat IČO, stanovy a výpis z rejstříku spolků.",
    relatedTemplateIds: ["automotive"],
  },
  {
  ...
  // ── FÁZE 3: Dotace a granty ──
  {
    ...
    nextMoveOnNe: "Nevadí — pokračovat s krajem a NSA.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Pokračovat s NSA a EU programy.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Nevadí — dotace jsou doplněk, ne hlavní zdroj.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Soustředit se na české dotační zdroje.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Soustředit se na firemní partnery a crowdfunding.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Přejít na fázi 5 — kombinované financování.",
    nextMoveOnPodminka: "Prodloužit kampaň nebo snížit cílovou částku.",
    relatedTemplateIds: ["parents"],
  },

  // ── FÁZE 5: Kombinované financování ──
  {
    id: "subsidized-lease",
    tier: 5,
    order: 1,
    ...
    nextMoveOnNe: "Přejít na fázi 6 — ojetina nebo úvěr.",
  ...
  // ── FÁZE 6: Poslední záchrana ──
  {
    ...
    nextMoveOnNe: "Odložit pořízení a pokračovat v budování zdrojů.",
