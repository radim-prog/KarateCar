...
export const decisionNodes: DecisionNode[] = [
  {
    ...
    steps: [
      ...
      "Paralelně kontaktovat Nadační fond Škoda Auto.",
    ...
    nextMoveOnNe: "Přejít na Tier 2: partnerský program jiné automobilky nebo nadační grant.",
    nextMoveOnPodminka: "Zjistit konkrétní podmínky a připravit požadované dokumenty.",
    relatedLeadIds: ["skoda-auto", "nfsa"],
  ...
  },
  {
    ...
    nextMoveOnNe: "Pokračovat Tierem 2 — zvýhodněný leasing nebo nadační grant.",
  ...
  },
  {
    ...
    tier: 2,
    order: 1,
    label: "Partnerský program automobilky",
    headline: "Zvýhodněný leasing nebo zápůjčka přes flotilový program",
    description:
      "I když auto nebude zdarma, automobilky nabízejí zvýhodněné flotilové podmínky, které mohou snížit měsíční splátku o 20-40 %.",
    estimatedValue: "Zvýhodněný leasing/zápůjčka",
    estimatedTimeframe: "2-4 týdny",
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["partner-club", "public-grants"],
    steps: [
      "Vyžádat si tři konkrétní nabídky: operativní leasing, úvěr, balón.",
      "Porovnat Toyota Proace Verso, Ford Tourneo a VW Caravelle.",
      "Vyjednat individuální podmínky pro neziskový subjekt.",
    ],
    risks: [
      "Flotilové podmínky bývají primárně pro firmy, ne spolky.",
    ...
    nextMoveOnNe: "Hledat financování přes nadace a veřejné dotace.",
  ...
  },
  {
    ...
    tier: 2,
    order: 2,
    label: "Nadační fond (Škoda Auto aj.)",
    headline: "Grant na mobilitu mládežnického sportu",
    description:
      "Nadační fondy automobilek i nezávislé nadace občas vypisují granty na sport, mobilitu nebo regionální rozvoj. Částky 100-500k Kč mohou pokrýt akontaci.",
    estimatedValue: "100-500 000 Kč",
    estimatedTimeframe: "1-3 měsíce",
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["public-grants", "partner-club"],
    steps: [
      "Prověřit grantový kalendář Nadačního fondu Škoda Auto.",
      "Zkontrolovat nadace zaměřené na sport a mládež (Nadace ČEZ, Nadace O2).",
    ...
    nextMoveOnAno: "Použít grant na akontaci nebo první splátky. Spustit leasing.",
    nextMoveOnNe: "Pokrýt akontaci z veřejných dotací a crowdfundingu.",
  ...
  },
  {
    ...
    tier: 2,
    order: 3,
    label: "Veřejné dotace",
    headline: "Město, kraj, NSA a EU programy jako provozní polštář",
    description:
      "Veřejné dotace přímo nezaplatí auto, ale uvolní klubový rozpočet na splátky. Město, kraj, NSA Můj klub — každý kousek pomůže.",
    estimatedValue: "50-300 000 Kč",
    estimatedTimeframe: "průběžně",
    difficulty: "low",
    probability: "high",
    complementaryIds: ["partner-club", "new-nonprofit"],
    steps: [
      "Ověřit aktuální výzvy města Rychnov, Královéhradeckého kraje a NSA.",
      "Podat žádost o provozní dotaci Můj klub 2026.",
      "Sledovat EU programy pro sport a mobilitu mládeže (Erasmus+ Sport).",
      "Kontaktovat odbor sportu města a kraje.",
    ],
    risks: [
      "Můj klub 2026 neumožňuje přímý nákup majetku nad 60 000 Kč.",
      "Termíny a způsobilé náklady se mění rok od roku.",
    ],
    nextMoveOnAno: "Uvolněné peníze z rozpočtu přesměrovat na splátky auta.",
    nextMoveOnNe: "Nevadí — dotace jsou doplněk, ne hlavní zdroj pro auto.",
  ...
  },
  {
    ...
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["public-grants", "crowdfunding"],
    steps: [
    ...
    nextMoveOnNe: "Žádat o vše pod stávajícím SHIN-KYO z.s.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Upravit balíčky nebo snížit měsíční cíl.",
  ...
  },
  {
    ...
    tier: 3,
    order: 3,
    label: "Operák z kombinace zdrojů",
    headline: "Operativní leasing pokrytý z více příjmových proudů",
    description:
    ...
    nextMoveOnNe: "Přejít na záložní plán — ojetina nebo crowdfunding na hotovostní nákup.",
  ...
  },
  {
    ...
    tier: 4,
    order: 1,
    label: "Jednorázová kampaň na akontaci",
    ...
    difficulty: "medium",
    probability: "medium",
    complementaryIds: ["partner-club", "own-loan"],
    steps: [
    ...
    nextMoveOnNe: "Přejít na vlastní úvěr jako poslední možnost.",
  ...
  },
  {
    ...
    nextMoveOnNe: "Odložit pořízení a pokračovat v budování partnerské sítě.",
...
export const fundingSources: FundingSource[] = [
  ...
  {
    id: "fs-automaker",
    label: "Flotilový program",
    type: "corporate",
    estimatedMin: 50000,
    estimatedMax: 300000,
    probability: "medium",
    linkedNodeId: "automaker-program",
    note: "Sleva 20-40 % na leasing přes flotilové podmínky.",
  },
  {
    id: "fs-foundation",
    label: "Nadační granty",
    type: "grant",
    estimatedMin: 100000,
    estimatedMax: 500000,
    probability: "medium",
    linkedNodeId: "foundation-grant",
    note: "Grant na mobilitu mládežnického sportu.",
  },
  {
    id: "fs-public",
    label: "Veřejné dotace",
    ...
    estimatedMax: 300000,
    probability: "high",
    linkedNodeId: "public-grants",
    note: "Město, kraj, NSA — provozní polštář.",
  },
  {
    id: "fs-partners",
    label: "Klub partnerů",
